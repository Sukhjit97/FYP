...
{
    public partial class StaffEditDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            void userdisplay()
            {
                ...
                String qry1 = "select * from tblStaff where StaffID='" + uid + "' ";
        ...
        protected void btnEditDetails_Click(object sender, EventArgs e)
        {
...

            {
                con.Open();
                string uid = Session["uid"].ToString();
                String update = "update tblStaff set Address='" + txtAddress.Text + "', Firstname='" + txtFirstname.Text + "', Surname='" + txtSurname.Text + "',  TelephoneNumber='" + txtTelephoneNumber.Text + "' , Password='" + hashedPassword + "' where StaffID='" + uid + "'";
